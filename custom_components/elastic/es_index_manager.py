...
from .const import (
    VERSION_SUFFIX, CONF_INDEX_FORMAT, CONF_ILM_POLICY_NAME,
    CONF_ILM_ENABLED, CONF_ILM_DELETE_AFTER, CONF_ILM_MAX_SIZE,
    INDEX_TEMPLATE_NAME
)
    ...
    async def _create_ilm_policy(self, config):
        ...
        try:
            ...
            if err.status_code == 404:
                ...
                LOGGER.exception(
                    "Error checking for existing ILM policy: %s", err)
                raise err
